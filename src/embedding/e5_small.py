"""Embedding adapter for intfloat/multilingual-e5-small."""
...
class E5SmallEmbeddingAdapter:
    """Adapter for intfloat/multilingual-e5-small.

    Lightweight 384-dim multilingual model (~471 MB fp16).
    Requires 'query: ' prefix for retrieval queries and 'passage: ' for documents.
    """
    ...
    def model_name(self) -> str:
        return EmbeddingModelName.MULTILINGUAL_E5_SMALL.value
    ...
    def unload(self) -> None:
        """Release MPS/CUDA memory held by the E5-small model."""
